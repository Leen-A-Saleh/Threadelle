...
namespace Threadelle.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Display(Name = "Gender")]
            public ApplicationUserGender Gender { get; set; } = ApplicationUserGender.Female;
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _ = _notifications.NotifyAdminsAsync(
                        ...
                        $"{user.FullName} ({Input.Email}) just created an account.",
