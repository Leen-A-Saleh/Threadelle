        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomOrderNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StoryTelling = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductStory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoldOutDisplayMode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SoldOutLabel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsOnePiece = table.Column<bool>(type: "bit", nullable: false),
                    HasColorOptions = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomOrderColors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomOrderColors_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomOrderColors_CustomOrders_CustomOrderId",
            ...
            migrationBuilder.CreateTable(
                name: "CustomOrderStatusHistories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomOrderStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomOrderStatusHistories_CustomOrders_CustomOrderId",
                        column: x => x.CustomOrderId,
                        principalTable: "CustomOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomOrderColors_ColorId",
                table: "CustomOrderColors",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomOrderColors_CustomOrderId_ColorId_Unique",
                table: "CustomOrderColors",
                columns: new[] { "CustomOrderId", "ColorId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomOrders_Number_Unique",
                table: "CustomOrders",
                column: "CustomOrderNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomOrderStatusHistories_CustomOrderId",
                table: "CustomOrderStatusHistories",
                column: "CustomOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductColors_ProductId_ColorId_Unique",
                table: "ProductColors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductMaterials_ProductId_MaterialId_Unique",
                table: "ProductMaterials",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserId_ProductId_Unique",
                table: "Wishlists",
